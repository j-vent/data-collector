...
# TODO: omit this and just pass in already trained models from previous baseline runs
...
# TODO: convert to stepwise later, right now just record at end of one game
step_stats = { 
