...
#        rv.store_ram_info(action, ram)
        ...
        if _ >= 4:
            ...
            lives = env.ale.lives()
            action_episode_sums, action_total_sums = dv.store_data(action, action_names[action], action_episode_sums, action_total_sums, reward, done, lives, mean_reward, characters, bg_locs)
