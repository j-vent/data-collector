...
find_element_centroid(pacman_colour, pacman_coord)
find_element_centroid(pink_ghost_colour, pink_ghost_coord)
find_element_centroid(red_ghost_colour, red_ghost_coord)
find_element_centroid(green_ghost_colour, green_ghost_coord)
find_element_centroid(orange_ghost_colour, orange_ghost_coord)
